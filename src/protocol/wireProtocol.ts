/**
 * RenegadeSwarm - BitTorrent Peer Wire Protocol (BEP 3 & BEP 10 Extensions)
 * Pure TypeScript wire message serialization, parsing, handshakes, and bitfield management.
 */
